...
**Returns:** An object with `confirmed`, `unconfirmed`, and `total` amounts in satoshis. Values may be decimal strings; use a bigint-aware formatter when displaying DOGE.
...
function GetBalance() {
  ...
  const getBalance = async () => {
    ...
    try {
      ...
      console.log("Total balance in satoshis:", result.total);
    } catch (error) {
      console.error("Failed:", error);
    }
  };
...
function SignMessage() {
  ...
  const signMessage = async () => {
    ...
    try {
      const signature = await currentProvider.signMessage("Hello Dogecoin");
...
function SignPsbt() {
  ...
  const signPsbt = async () => {
    ...
    try {
      const signedPsbt = await currentProvider.signPsbt("psbtHexString");
...
export function DogecoinProviderExample() {
  ...
  const handleSignMessage = async () => {
    try {
      const signature = await currentProvider.signMessage("Hello from Dogecoin");
      console.log("Signature:", signature);
    } catch (error) {
      console.error("Error:", error);
    }
